...
Everything streams: memory barely grows with the file (five minutes of stereo peak at 428 MB, sixty minutes at 704 MB, [docs/PERF.md](docs/PERF.md))
...
- **Tests**: 182, 91 % line coverage on `src/`, run with `uv run pytest`. CI
  runs 152 of them on Ubuntu, macOS and Windows on every push. The 29 EBU cases
