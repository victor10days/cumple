...
- Not readable: two Netflix partner-help articles redirect to a JS app (README:449). telestream.com's Qualify-for-Vantage PDF 404s; those claims come from vantage-analysis.htm instead.
...
Src: [1] emotion-systems.com/products/eff [2] emotion-systems.com/engine-loudness-solutions [3] telestream.net/vidchecker/specs.htm [4] telestream.net/vantage/vantage-analysis.htm [5] sdvi.com/wp-content/uploads/2021/11/Baton_Datasheet-2021.pdf [6] interrasystems.com/file-based-qc.php [7] veneratech.com/pulsar-automated-file-qc/ [8] telestream.net/pdfs/datasheets/Aurora-Automated-File-based-Quality-Control-System-Datasheet-2NW6005410.pdf [9] telestream.net/pdfs/support/Telestream_Aurora_EOS-Announcement.pdf [10] telosalliance.com/file-based-audio-processing/audio-automation-for-enterprise/minnetonka-audiotools-server [11] auphonic.com/ [12] auphonic.com/help/web/preset.html [13] loudnesspenalty.com/ [14] npfp.netflixstudios.com/program-conditions [15] partnerhelp.netflixstudios.com/hc/en-us/articles/360057627193-Welcome-to-Asset-QC

Some, not most, check cumple's gaps: Dolby E (3/9: eFF, Aurora, Vantage Pro); Atmos/ADM (2/9: Vantage Pro, Baton); codec/container (3/9: Vidchecker, Pulsar, Netflix); A/V duration/sync (1/9: Baton). Auphonic, Loudness Penalty have none.
...
1. Codec/container conformance: 3 of 9 (4 counting Baton's Dolby AC-3/Digital Plus/Dolby-E support).
...
6. 2-pop/leader/slate: 1 of 9 (Baton, container-side).

## 4. Unknowns

- Whether Vidchecker, Pulsar, Aurora, AudioTools check 2-pop or leader; unconfirmed.
...
- Whether Baton's 2021 datasheet still matches its current page's checks.

## 5. Recommendation

Codec/container and Dolby E are cumple's widest gaps (3 of 9 each); Atmos/ADM is next (2 of 9). A read-only Dolby E/MXF/AC-3 check closes most ground; nothing matches cumple's clause-with-grade or stem-null diff, so keep it.
